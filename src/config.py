...
class GPT2Config(object):
    """
        def __init__(
            self,
            vocab_size_or_config_json_file=5256,
            n_positions=1024,
            n_ctx=1024,
            n_embd=768,
            n_layer=12,
    ...
    def __init__(
            self,
            vocab_size_or_config_json_file=4658,
            n_positions=1024, # 32 better probably
            n_ctx=1024,
            n_embd=16,
            n_layer=3,
            n_head=4,
...
def init_param(opt):
    global run_model, model_type, loss_type, sa, CUDA, device, data_shuffle, samples_num, vocab_size, \
        ...
        use_nll_oracle, use_nll_gen, use_nll_div, use_bleu, use_self_bleu, use_clas_acc, use_ppl, show_rewards, show_probs, run_validation
    ...
    tips = opt.tips
    show_rewards = opt.show_rewards
    show_probs = opt.show_probs
