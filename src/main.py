...
def program_config(parser):
    ...
    parser.add_argument('--show_rewards', default=cfg.show_rewards, type=int)
    parser.add_argument('--show_probs', default=cfg.show_probs, type=int)
    parser.add_argument('--run_validation', default=cfg.run_validation, type=int)
...
if __name__ == '__main__':
    ...
    # ===Dict===
    if cfg.if_real_data:
        from instructor.real_data.gpt_dpgan_instructor import  GPT_DPGANInstructor


    instruction_dict = {
        'gpt_dpgan': GPT_DPGANInstructor,
